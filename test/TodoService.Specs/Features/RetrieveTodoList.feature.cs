...
namespace TodoService.Specs.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("Retrieve Todo List")]
    public partial class RetrieveTodoListFeature
    {
...
#line 1 "RetrieveTodoList.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Retrieve Todo List", "  As a User,\r\n  I want to retrieve my todo list\r\n  So that I can see information " +
                    "about my tasks", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Retrieve todo list when there are no entries")]
        public virtual void RetrieveTodoListWhenThereAreNoEntries()
        {
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Retrieve todo list when there are existing entries")]
        public virtual void RetrieveTodoListWhenThereAreExistingEntries()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
